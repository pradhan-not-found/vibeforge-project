...
export default function Login() {
  return (
    <div className="min-h-screen bg-surface flex flex-col justify-center items-center px-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-[420px] bg-white/60 backdrop-blur-xl rounded-2xl p-8 sm:p-10 border border-white/40 shadow-[0_8px_30px_rgb(0,0,0,0.04)] relative z-10">
        <div className="text-center mb-8 flex flex-col items-center">
          ...
          <p className="text-[14px] text-ink-muted leading-relaxed">Enter your credentials to access your Web Application Firewall dashboard.</p>
        </div>
