...
export default function RootLayout({
  ...
  return (
    <html lang="en" className={`h-full antialiased __variable_d1bf66 __variable_e942f7 __variable_ab318e __variable_1018ec ${GeistPixelGrid.variable}`} suppressHydrationWarning>
